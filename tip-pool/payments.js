...
function createCurPayment() {
    ...
    if (Number(billAmt) > 0 && Number(tipAmt) >= 0) {
        return {
            ...
            tipAmt: tipAmt, //ie $30
            tipPercent: calculateTipPercent(billAmt, tipAmt), //ie(100/(300/30))==.
        }
...
function updateSummary() {
    ...
    if (paymentTotal === 0 && numberOfPayments === 0) {
        ...
        tipPercentAvg = paymentTotal / numberOfPayments; //Object.keys(allPayments).length;
    }
